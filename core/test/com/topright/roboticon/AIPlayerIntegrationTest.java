...
public class AIPlayerIntegrationTest {
	...
	// Unfortunately we still must mock the plotManager due to limitations imposed upon us by LibGDX
	// The tests fail when it is not mocked as there is no LibGDX application created by these tests
